...
2. Run `/apicontract all normal` to capture curves, sex, names, numbers and publication. Use `/apicontract curves`, `/apicontract sex <label>` or `/apicontract names <label>` to capture separately.
