...
SlashCmdList.APICONTRACTPROBE = function(input)
    ...
    local slot
    if mode == "action-state" or mode == "actions" or mode == "spell-metadata" or mode == "spell-duration" or mode == "spellbook-metadata" or mode == "spellbook-duration" then
