...
Private enumeration and the pre-12.1.5 caster-GUID tombstone remain gated at 12.1.0. The actual `GetAuraCasterGUID` implementation remains gated at 12.1.5; sound-trigger enum registration and private helpers retain their 12.1.0 gates.
