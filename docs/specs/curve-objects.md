...
The test-only commit reproduces the actual processor rejection, not merely a type mismatch. Targeted GREEN and full-addon integration are separate proof stages.
