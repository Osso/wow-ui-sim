...
- [ ] Verify commit `a6924a8c9` after moving six completed-startup player, action-bar, dropdown, and chat-config behaviors. Implementer evidence records 6/6 pass, integration 8,366, prefork 2,011, and zero overlap. Keep pre-start channel-checkbox instrumentation in ordinary integration.
