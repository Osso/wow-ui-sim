...
Grouped regressions: `tests/wowforever_table_security.rs`. Initial RED: all three tests fail because `settablesecurity` is absent. Final runtime and earlier-profile gates remain integration-owner responsibilities.
