...
| Texture atlases | `5cd134dcd` | Generates and selects atlas data from exact `1.60.1.69913` DB2/listfile inputs, including provenance and a Forever atlas fixture. This avoids fabricated atlas rectangles; final runtime verification remains pending. |
