...
- Implement real table-security enforcement for `CooldownViewerSecure.lua`: user explicitly approved this rilua work on September 20, 2026. The required `settablesecurity` rules are pending; no no-op shim or broader secret-conformance claim is made.
