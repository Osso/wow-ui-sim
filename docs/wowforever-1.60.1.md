...
| Inventory slot methods | `68989ffcf` | Publishes existing `C_PaperDollInfo` inventory-slot methods for Forever; development fixture covers real equipment-button and namespace slot contracts. Full startup rerun remains pending. |
