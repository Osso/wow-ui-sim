//! Valid WoW event names A–F (split for file-length limits).
//! Sorted for binary search. Part 1 of 3.

pub const EVENTS_A: &[&str] = &[
    ...
    "AZERITE_EMPOWERED_ITEM_RESPEC_CLOSE",
